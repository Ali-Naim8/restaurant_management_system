...
const Navbar = () => {
  ...
  // isSticky: State variable to determine if the navbar is sticky or not.
  const { user, loading } = useAuth();
  // user and loading: Values obtained from the useAuth hook to manage user authentication status.
  const [cart, refetch] = useCart();
  // cart and refetch: Values obtained from the useCart hook to manage the user's shopping cart.
      ...
      <li tabIndex={0}>
        <details>
          ...
          <ul className="p-2">
            ...
            <li>
              <a href="/booking-page">Table Booking</a>
            </li>
          </ul>
        </details>
      </li>
